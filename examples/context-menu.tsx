...
} from "@/components/docs/examples/context-menu-interactive"
...
function ContextMenuBasicDemo() {
  return <ContextMenuBasicInteractive />
}
...
const contextMenuCheckboxCode = `"use client"
...
function ContextMenuCheckboxDemo() {
  return <ContextMenuCheckboxInteractive />
}
...
const contextMenuRadioCode = `"use client"
...
function ContextMenuRadioDemo() {
  return <ContextMenuRadioInteractive />
}
...
export {
  ...
  contextMenuCheckboxCode,
  ContextMenuRadioDemo,
  contextMenuRadioCode,
}
